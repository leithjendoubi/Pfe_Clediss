...
const DOCUMENT_TYPES = {
  FARMERS_UNION_FORM: "Farmers Union Form",
  APPLICANT_STATUS_CERTIFICATE: "Applicant Status Certificate",
...
const DemandProducteur = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Producteur registration submitted successfully!');
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-2xl font-bold mb-6 text-center">Producteur Registration</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {Object.entries({
            ...
            categorieProduitMarche: 'Product Category',
            nometprenomlegal: 'Legal Name',
            adressDeStockage: 'Storage Address (Optional)',
            typeDesProducteurs: 'Producer Type'
          }).map(([field, label]) => (
            <div key={field}>
              ...
              <input
                ...
                required={field !== 'adressDeStockage'}
                placeholder={
                  field === 'numeroPhone' ? 'e.g., +21612345678' :
                  field === 'typeDesProducteurs' ? 'e.g., Farmer, Distributor' : ''
                }
              />
            </div>
          ))}
