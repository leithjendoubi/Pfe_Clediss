...
const CreateProduct = () => {
  ...
  const [units] = useState(["Litre", "Kilogramme", "Tonnes", "Gramme"]);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-blue-100 rounded-xl shadow-sm p-6">
            ...
            <p className="text-gray-700 text-sm leading-relaxed" style={{ fontFamily: "'Amiri', serif" }}>
              ٠ فصل عدد 4 : يمنع التعامل وشراء المنتجات الفلاحية والصيد البحري خارج الفضاءات المرخصة لها والأسواق المنشأة من قبل الدولة.
